...
<![endif]-->`;
        ...
        case ModuleType.IMAGE:
            content = `<table cellspacing="0" cellpadding="0" border="0" style="max-width: 640px; margin: auto;">
    <tbody>
        <tr>
            <td style="padding: 0;">
        ...
        case ModuleType.TABLE:
            ...
            content = `<table cellspacing="0" cellpadding="0" border="0" style="width: 100%; max-width: 640px; margin: 25px auto; border-collapse: collapse; font-size: 14px; border: 1px solid #dddddd; border-radius: 8px; overflow: hidden;">
    <tbody>${rowsHtml}
    </tbody>
</table>`;
            break;
